...
public class NumBaseballGame2 extends JFrame implements ActionListener {
	...
	private void continueGame(){
		...
		if (strikeCnt == 3) {
			//메시지 출력, 팝업
			String msg="축하합니다~!!^^"+baseballAnswer[0]+baseballAnswer[1]+ baseballAnswer[2]+"는 정답입니다!";
			ta.append(msg+"\n");
			showDialog(msg);
